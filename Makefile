...
# Source files
SRCS = src/value.c src/bedrock_array.c src/bedrock_list.c src/bedrock_stack.c src/bedrock_queue.c src/bedrock_bst.c src/bedrock_hmap.c src/heap.c src/graph.c
OBJS = $(SRCS:.c=.o)

# Test executables
TEST_BINS = tests/test_bedrock_array tests/test_bedrock_list tests/test_bedrock_stack tests/test_bedrock_queue tests/test_stack tests/test_queue tests/test_bst tests/test_bedrock_hmap tests/test_heap tests/test_graph
...
tests/test_bedrock_hmap: tests/test_bedrock_hmap.c src/value.o src/bedrock_hmap.o
	$(CC) $(CFLAGS) $(INCLUDE) $^ -o $@
